    ...
    <div className="mx-auto max-w-2xl px-4 py-6 pb-24">
        ...
        <div className="card mb-5 flex flex-wrap items-center justify-between gap-3 p-4">
          <div className="min-w-0">
            ...
            <div className="truncate text-sm font-semibold">
              jualbeliusupolmed.web.id/toko/{slugAwal}
            </div>
          </div>
          <div className="flex gap-2">
            <button
              type="button"
              onClick={() => {
                navigator.clipboard?.writeText(`https://www.jualbeliusupolmed.web.id/toko/${slugAwal}`);
      ...
      <form onSubmit={simpan} className="space-y-5">
        <Bagian judul="Identitas">
          ...
          <Isian label="Alamat toko" petunjuk="Ini yang kamu bagikan ke pembeli. Boleh diubah, tapi tautan lama akan mati.">
