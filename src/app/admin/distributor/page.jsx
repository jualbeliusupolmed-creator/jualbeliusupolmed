...
export default async function AdminDistributorPage() {
  if (!isAdmin()) {
    return <AdminLogin />;
  }
  ...
  try {
    data = await getAdminStats(1, "distributor");
  } catch (e) {
    return (
  ...
  return <DistributorClient settings={data.settings || {}} categories={data.categories || []} />;
}
