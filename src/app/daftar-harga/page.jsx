    ...
    <div className="mx-auto max-w-5xl px-4 py-8">
      ...
      <section className="mt-12 grid gap-6 md:grid-cols-2">
        ...
        <div className="card p-6">
          ...
          <p className="mt-2 text-sm text-gray-500 leading-relaxed">
            Untuk klaim pengembalian dana akibat kesalahan teknis pembayaran, silakan hubungi admin melalui nomor WhatsApp resmi yang tertera pada platform dengan melampirkan bukti pembayaran DOKU yang sah.
          </p>
        </div>
      </section>
