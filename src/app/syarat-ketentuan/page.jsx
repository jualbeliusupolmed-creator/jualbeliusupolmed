    ...
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <div className="card mt-8 p-6 sm:p-8 space-y-6 text-sm text-gray-600 leading-relaxed">
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>Layanan jasa periklanan (iklan barang, poster, *bump*, dan *featured ads*) pada platform kami diproses menggunakan sistem gateway pembayaran pihak ketiga yang aman (DOKU).</li>
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              Untuk mengajukan klaim pengembalian akibat kegagalan transaksi teknis, pengguna dapat mengirimkan bukti transfer DOKU yang sah ke layanan kontak pelanggan kami.
            </li>
          </ul>
        </div>
