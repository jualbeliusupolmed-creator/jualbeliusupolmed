...
export default function JasaBrowser({
  initialListings,
  initialTotal,
  featured,
  trending = [],
  ...
  const applyFilters = useCallback(
    async ({
      ...
      setPage(1);
      try {
        const params = new URLSearchParams({ page: 1, limit: PAGE_SIZE, sort: newSort, type: "jasa" });
  ...
  async function loadMore() {
    ...
    try {
      const params = new URLSearchParams({ page: nextPage, limit: PAGE_SIZE, sort, type: "jasa" });
          ...
          <div key="main">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Cari jasa… joki, desain, service laptop"
            ...
            {searching ? (
              ...
              <div className="mt-8 mb-12 flex flex-col items-center justify-center py-16 px-4 text-center bg-gray-50/50 dark:bg-slate-900/20 rounded-3xl border border-gray-100 dark:border-slate-800/60">
                ...
                <h3 className="text-xl font-extrabold text-gray-900 dark:text-white mb-2">Belum ada jasa di kategori ini</h3>
                <p className="max-w-md text-sm text-gray-500 dark:text-slate-400 mb-8 leading-relaxed">
                  Jadilah yang pertama menawarkan jasamu di sini!
                </p>
                <Link
                  href="/jasa/tawarkan"
