/*
 * Tampilan halaman Ringkasan — dipisah dari halamannya supaya bisa dipakai
 * DUA kali: /admin/overview mengisinya dengan angka sungguhan, dan
 * /admin-demo/overview dengan angka karangan. Dipisah, bukan disalin: dua
 * salinan halaman ringkasan akan berbeda dalam hitungan minggu, dan yang
 * dilihat orang untuk mempelajari panel ini justru salinan yang basi.
 *
 * Ia menerima `stats` apa adanya — bentuk yang sama dengan yang dikembalikan
 * getOverviewStats().
 */
